...
%% Rigidez
Kte = 5e6;      % rigidez da suspensão traseira esquerda [N/m]
Ktd = 5e6;      % rigidez da suspensão traseira direita [N/m]
Kde = 3e6;      % rigidez da suspensão dianteira esquerda [N/m]
Kdd = 3e6;      % rigidez da suspensão dianteira direita [N/m]
...
%% Inércias
If = 5e6;       % inércia flexional do chassis [kg*m^2]
It = 5e6;       % inércia torcional do chassis [kg*m^2]
